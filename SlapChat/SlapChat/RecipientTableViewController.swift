...
//  SlapChat
//
//  Created by Betty Fung on 7/22/16.
...
//        let recipientEntity = NSEntityDescription.entityForName("Recipient", inManagedObjectContext: dataStore.managedObjectContext)
//        let messageEntity = NSEntityDescription.entityForName("Message", inManagedObjectContext: dataStore.managedObjectContext)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let eachRecipient = dataStore.recipients[indexPath.row]
